 ...
 * offset ' ' (0x20).
 * Stroke order optimized to minimize pen-up beam travel for vector displays.
 */
...
const hershey_char_t hershey_simplex[] =
{
   ...
   {
      5,16, /* Ascii 34 " */
      4,21, 4,14, -1,-1, 12,14, 12,21,
   },

   {
      11,21, /* Ascii 35 # */
      11,25, 4,-7, -1,-1, 10,-7, 17,25, -1,-1, 18,12, 4,12, -1,-1, 3, 6, 17, 6,
   },
   ...
   {
      31,24, /* Ascii 37 % */
       8,21,10,19,10,17, 9,15, 7,14, 5,14, 3,16, 3,18, 4,
      20, 6,21, 8,21,10,20,13,19,16,19,19,20,21,21,-1,-1,21,21, 3, 0,-1,-1,17, 7,15, 6,14, 4,
   ...
   {
      8,16, /* Ascii 42 * */
      3,18,13,12,-1,-1, 8, 9, 8,21,-1,-1,13,18, 3,12,
   },
   ...
   {
      55,27, /* Ascii 64 @ */
      11, 5,10, 6, 9, 8, 9,11,10,14,12,16,-1,-1,18,13,17,15,15,16,12,16,10,
      15, 9,14, 8,11, 8, 8, 9, 6,11, 5,14, 5,16, 6,17, 8,-1,-1,19, 5,18, 6,
      18, 8,19,16,-1,-1,18,16,17, 8,17, 6,19, 5,21, 5,23, 7,24,10,24,12,23,
      15,22,17,20,19,18,20,15,21,12,21, 9,20, 7,19, 5,17, 4,15, 3,12, 3, 9,
       4, 6, 5, 4, 7, 2, 9, 1,12, 0,15, 0,18, 1,20, 2,21, 3,
   },

   {
      8,18, /* Ascii 65 A */
      1, 0, 9,21,-1,-1, 9,21,17, 0,-1,-1,14, 7, 4, 7,
   },

   {
      23,21, /* Ascii 66 B */
      13,11,16,12,17,13,18,15,18,17,17,19,16,20,13,21, 4,21,-1,-1, 4,21, 4,
       0,-1,-1, 4, 0,13, 0,16, 1,17, 2,18, 4,18, 7,17, 9,16,10,13,11, 4,11,
   },
   ...
   {
      15,21, /* Ascii 68 D */
      4,21, 4, 0,-1,-1, 4, 0,11, 0,14, 1,16, 3,17, 5,18, 8,18,13,17,16,16,
      18,14,20,11,21, 4,21,
   },

   {
      7,19, /* Ascii 69 E */
      17, 0, 4, 0, 4,21,17,21,-1,-1, 4,11,12,11,
   },

   {
      8,18, /* Ascii 70 F */
      17,21, 4,21,-1,-1, 4,21, 4, 0,-1,-1, 4,11,12,11,
   },
   ...
   {
      8,22, /* Ascii 72 H */
      4, 0, 4,21,-1,-1, 4,11,18,11,-1,-1,18,21,18, 0,
   },
   ...
   {
      8,21, /* Ascii 75 K */
      18,21, 4, 7,-1,-1, 4, 0, 4,21,-1,-1, 9,12,18, 0,
   },
   ...
   {
      11,24, /* Ascii 77 M */
      4, 0, 4,21,-1,-1, 4,21,12, 0,-1,-1,12, 0,20,21,-1,-1,20,21,20, 0,
   },

   {
      8,22, /* Ascii 78 N */
      4, 0, 4,21,-1,-1, 4,21,18, 0,-1,-1,18, 0,18,21,
   },
   ...
   {
      13,21, /* Ascii 80 P */
      4, 0, 4,21,-1,-1, 4,21,13,21,16,20,17,19,18,17,18,14,17,12,16,11,13,
      10, 4,10,
   },
   ...
   {
      16,21, /* Ascii 82 R */
      4, 0, 4,21,-1,-1, 4,21,13,21,16,20,17,19,18,17,18,15,17,13,16,12,13,
   ...
   {
      5,18, /* Ascii 86 V */
      1,21, 9, 0,-1,-1, 9, 0,17,21,
   },

   {
      11,24, /* Ascii 87 W */
      2,21, 7, 0,-1,-1, 7, 0,12,21,-1,-1,12,21,17, 0,-1,-1,17, 0,22,21,
   },

   {
      5,20, /* Ascii 88 X */
      3,21,17, 0,-1,-1, 3, 0,17,21,
   },

   {
      6,18, /* Ascii 89 Y */
      1,21, 9,11, 9, 0,-1,-1, 9,11,17,21,
   },

   {
      8,20, /* Ascii 90 Z */
      3,21,17,21,-1,-1,17,21, 3, 0,-1,-1, 3, 0,17, 0,
   },

   {
      11,14, /* Ascii 91 [ */
      5,-7, 5,25,-1,-1,11,25, 4,25,-1,-1, 4,25, 4,-7,-1,-1, 4,-7,11,-7,
   },
   ...
   {
      11,14, /* Ascii 93 ] */
      9,-7, 9,25,-1,-1, 3,25,10,25,-1,-1,10,25,10,-7,-1,-1,10,-7, 3,-7,
   },

   {
      10,16, /* Ascii 94 ^ */
      3,12, 8,17,13,12,-1,-1,10,15, 8,18, 6,15,-1,-1, 8,17, 8, 0,
   },
   ...
   {
      17,19, /* Ascii 97 a */
      15,14,15, 0,-1,-1,15, 3,13, 1,11, 0, 8, 0, 6, 1, 4, 3, 3, 6, 3, 8, 4,
      11, 6,13, 8,14,11,14,13,13,15,11,
   },

   {
      17,19, /* Ascii 98 b */
      4,21, 4, 0,-1,-1, 4, 3, 6, 1, 8, 0,11, 0,13, 1,15, 3,16, 6,16, 8,15,
      11,13,13,11,14, 8,14, 6,13, 4,11,
   },
   ...
   {
      17,19, /* Ascii 100 d */
      15,21,15, 0,-1,-1,15, 3,13, 1,11, 0, 8, 0, 6, 1, 4, 3, 3, 6, 3, 8, 4,
      11, 6,13, 8,14,11,14,13,13,15,11,
   },
   ...
   {
      8,12, /* Ascii 102 f */
      5, 0, 5,17, 6,20, 8,21,10,21,-1,-1, 9,14, 2,14,
   },

   {
      22,19, /* Ascii 103 g */
      6,-6, 8,-7,11,-7,13,-6,14,-5,15,-2,15,14,-1,-1,15,11,13,13,11,14, 8,
   ...
   {
      8,17, /* Ascii 107 k */
      4,21, 4, 0,-1,-1, 4, 4,14,14,-1,-1, 8, 8,15, 0,
   },
   ...
   {
      18,30, /* Ascii 109 m */
      4, 0, 4,14,-1,-1, 4,10, 7,13, 9,14,12,14,14,13,15,10,15, 0,-1,-1,15,
      10,18,13,20,14,23,14,25,13,26,10,26, 0,
   },

   {
      10,19, /* Ascii 110 n */
      4, 0, 4,14,-1,-1, 4,10, 7,13, 9,14,12,14,14,13,15,10,15, 0,
   },
   ...
   {
      17,19, /* Ascii 112 p */
      4,-7, 4,14,-1,-1, 4,11, 6,13, 8,14,11,14,13,13,15,11,16, 8,16, 6,15,
      3,13, 1,11, 0, 8, 0, 6, 1, 4, 3,
   },

   {
      17,19, /* Ascii 113 q */
      15,-7,15,14,-1,-1,15,11,13,13,11,14, 8,14, 6,13, 4,11, 3, 8, 3, 6, 4,
      3, 6, 1, 8, 0,11, 0,13, 1,15, 3,
   },

   {
      8,13, /* Ascii 114 r */
      4, 0, 4,14,-1,-1, 4, 8, 5,11, 7,13, 9,14,12,14,
   },
   ...
   {
      8,12, /* Ascii 116 t */
      10, 0, 8, 0, 6, 1, 5, 4, 5,21,-1,-1, 2,14, 9,14,
   },

   {
      10,19, /* Ascii 117 u */
      4,14, 4, 4, 5, 1, 7, 0,10, 0,12, 1,15, 4,-1,-1,15, 0,15,14,
   },

   {
      5,16, /* Ascii 118 v */
      2,14, 8, 0,-1,-1, 8, 0,14,14,
   },

   {
      11,22, /* Ascii 119 w */
      3,14, 7, 0,-1,-1, 7, 0,11,14,-1,-1,11,14,15, 0,-1,-1,15, 0,19,14,
   },

   {
      5,17, /* Ascii 120 x */
      3,14,14, 0,-1,-1, 3, 0,14,14,
   },

   {
      9,16, /* Ascii 121 y */
      2,14, 8, 0,-1,-1, 1,-7, 2,-7, 4,-6, 6,-4, 8, 0,14,14,
   },

   {
      8,17, /* Ascii 122 z */
      3,14,14,14,-1,-1,14,14, 3, 0,-1,-1, 3, 0,14, 0,
   },
...
//   },
...

   {
      ...
      -1,21,12,21,10,20, 7,18, 6,16, 6,14, 7,10,10, 8,11, 6,11, 4,10, 3, 8,
   },
};
